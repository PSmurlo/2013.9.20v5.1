...
[leng.wire.cb2inv1,longestcb2inv1way,leng.wire.cb2inv,qHleft] = aluminumRuns(numCB,qH,totH,5); % total wire length north-south (meters)
...
cost.labor.CTwire.cb2inv = leng.wire.cb2inv1 * 8;
