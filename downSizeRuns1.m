function [trunkInfo]=downSizeRuns(lvector,maxVD,cbStrings,minIndex,maxAWG,leftoverWireSize,qHleft)

global modPV cb2invRes type wirePriceCu2kV wirePriceAl1kV inv

if type(1,2)==0
    wirePrice=wirePriceAl1kV;
else
    wirePrice=wirePriceCu2kV;
end
